...
public class InstructionsPanel extends JPanel implements KeyListener {
   ...
   public InstructionsPanel(Window w){ //constructor
      ...
      messages[0] = Utils.messagePanel("In this game, you get to simulate a planet like out Earth! The game ends when the" +
            ...
            "popup QTEs grant special effects that will help you in your journey. Failing to click on them can lead to unwanted effects",400,150,300,300);
      messages[1] = Utils.messagePanel("Rock - Gives rock on click and soil if there is enough rock. Turns into lava if you ignore\n" +
            ...
            "Lava - Heats up the planet a bit if clicked, heats the planet up a lot if missed",400,150,300,300);
      messages[2] = Utils.messagePanel("Soil - Increases the population of a species\n" +
            "Smog - Activates a climate related minigame on click, On minigame fail or miss, your species die and can go extinct",400,150,300,300);
